...
export const getAlbums = () => axios.get(`${import.meta.env.VITE_BASE_API}/songs/albums`).then(response => response.data.data);
export const getArtists = () => axios.get(`${import.meta.env.VITE_BASE_API}/songs/artists`).then(response => response.data.data);
export const getGenres = () => axios.get(`${import.meta.env.VITE_BASE_API}/songs/genres`).then(response => response.data.data);
